...
>[本文仓库地址](https://github.com/ruochuan12/jquery-analysis.git)：`git clone https://github.com/ruochuan12/jquery-analysis.git`
...
相关代码和资源放置在[github blog](https://github.com/ruochuan12/blog)中，需要的读者可以自取。
