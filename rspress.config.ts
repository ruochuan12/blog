...
export default defineConfig({
	...
	themeConfig: {
		...
		nav: [
			...
			{
				text: "源码共读",
				link: "https://www.yuque.com/ruochuan12/read-source-code/notice/p0",
				items: [
					{
						text: "语雀链接",
						link: "https://www.yuque.com/ruochuan12/read-source-code/notice/p0",
				  ...
				  items: [
					{
					  ...
					  link: '/read-source-code/notice/p56',
					},
					{
					  text: '第55期 | Taro 源码揭秘 3. taro init',
					  link: '/read-source-code/notice/p55',
					},
					{
					  text: '第54期 | Taro 源码揭秘 2. 插件机制',
					  link: '/read-source-code/notice/p54',
					},
					{
					  text: '第53期 | Taro 源码揭秘 1. taro init 初始化项目',
					  link: '/read-source-code/notice/p53',
					},
					{
					  text: '第52期 | 分析 vant4 组件库源码，写一个 Vue3 highlight 高亮文本的组件',
					  link: '/read-source-code/notice/p52',
					},
					{
					  text: '第51期 | fileSaver 考虑周到的下载文件库',
					  link: '/read-source-code/notice/p51',
					},
					{
					  text: '第50期 | 剖析 localForage 源码，学习本地存储库原理',
					  link: '/read-source-code/notice/p50',
					},
					{
					  text: '第49期 | 剖析 hotkeys-js 源码，学会快捷键实现原理',
					  link: '/read-source-code/notice/p49',
					},
					{
					  text: '第48期 | axios 是如何打包发布的，如何开发工具库',
					  link: '/read-source-code/notice/p48',
					},
					{
					  text: '第47期 | vant4.0 正式发布了，分析其源码学会用 vue3 写一个图片懒加载组件！',
					  link: '/read-source-code/notice/p47',
					},
					{
					  text: '第46期 _ 分析 vant4 源码，学会用 vue3 + ts 开发毫秒级渲染的倒计时组件，真是妙啊',
					  link: '/read-source-code/notice/p46',
					},
					{
					  text: '第45期 | 分析 vant4 源码，如何用 vue3 + ts 开发一个瀑布流滚动加载的列表组件？',
					  link: '/read-source-code/notice/p45',
					},
					{
					  text: '第44期 | 神器啊，从未想过 VSCode 还能这样直接打开仓库URL，原理揭秘~',
					  link: '/read-source-code/notice/p44',
					},
					{
					  text: '第43期 | 学习 react-use 源码，写自定义 hooks 越来越顺',
					  link: '/read-source-code/notice/p43',
					},
					{
					  text: '第42期 | 跟着 vant4 源码学习如何用 vue3+ts 开发一个 loading 组件，仅88行代码',
					  link: '/read-source-code/notice/p42',
					},
					{
					  text: '第41期 | vant 4 正式发布了，支持暗黑主题，那么是如何实现的呢',
					  link: '/read-source-code/notice/p41',
					},
					{
					  text: '第40期 | vite 是如何解析用户配置的 .env 的',
					  link: '/read-source-code/notice/p40',
					},
					{
					  text: '第39期 | 如何发布一个 npm 库，自动化管理版本号、生成 changelog、tag 等',
					  link: '/read-source-code/notice/p39',
					},
					{
					  text: '第38期 | 经常用 vant-weapp 开发小程序，却不知道如何开发一个组件？学！',
					  link: '/read-source-code/notice/p38',
					},
					{
					  text: '第37期 | vite 3.0 都发布了，经常初始化 vite 项目，却不知 create-vite 原理？揭秘！',
					  link: '/read-source-code/notice/p37',
					},
					{
					  text: '第36期 | 可能是历史上最简单的一期 omit.js 剔除对象中的属性',
					  link: '/read-source-code/notice/p36',
					},
					{
					  text: '第35期 | 为 vite 项目自动添加 eslint 和 prettier',
					  link: '/read-source-code/notice/p35',
					},
					{ text: '第34期 | tdesign-vue 初始化组件', link: '/read-source-code/notice/p34' },
					{ text: '第33期 | arrify 转数组', link: '/read-source-code/notice/p33' },
					{ text: '第32期 | yocto-queue 队列 链表', link: '/read-source-code/notice/p32' },
					{ text: '第31期 | p-limit 限制并发数', link: '/read-source-code/notice/p31' },
					{
					  text: '第30期 | @tarojs_plugin-mini-ci 小程序上传代码 ci',
					  link: '/read-source-code/notice/p30',
					},
					{ text: '第29期 | quick-lru', link: '/read-source-code/notice/p29' },
					{
					  text: '第28期 | vue react 小程序 message 组件',
					  link: '/read-source-code/notice/p28',
					},
					{ text: '第27期 | read-pkg', link: '/read-source-code/notice/p27' },
					{ text: '第26期 | classnames', link: '/read-source-code/notice/p26' },
					{ text: '第25期 | 跟着underscore学防抖', link: '/read-source-code/notice/p25' },
					{ text: '第24期 | vue2工具函数', link: '/read-source-code/notice/p24' },
					{
					  text: '第23期 | 为什么 Vue2 this 能够直接获取到 data 和 methods',
					  link: '/read-source-code/notice/p23',
					},
					{ text: '第22期 | dotenv', link: '/read-source-code/notice/p22' },
					{ text: '第21期 | await-to-js', link: '/read-source-code/notice/p21' },
					{ text: '第20期 | install-pkg', link: '/read-source-code/notice/p20' },
					{ text: '第19期 | axios 工具函数', link: '/read-source-code/notice/p19' },
					{
					  text: '第18期 | delay  带取消功能的延迟函数',
					  link: '/read-source-code/notice/p18',
					},
					{ text: '第17期 | js-cookie', link: '/read-source-code/notice/p17' },
					{ text: '第16期 | 一行代码统一规范 包管理器', link: '/read-source-code/notice/p16' },
					{ text: '第15期 | element 初始化组件功能', link: '/read-source-code/notice/p15' },
					{ text: '第14期 | promisify', link: '/read-source-code/notice/p14' },
					{ text: '第13期 | open 打开浏览器', link: '/read-source-code/notice/p13' },
					{ text: '第12期 | 尤雨溪推荐 的ni 神器', link: '/read-source-code/notice/p12' },
					{ text: '第11期 | 玩具 vite', link: '/read-source-code/notice/p11' },
					{ text: '第10期 | configstore 存储', link: '/read-source-code/notice/p10' },
					{
					  text: '第9期 | create-vue Vue 团队公开的全新脚手架工具',
					  link: '/read-source-code/notice/p9',
					},
					{ text: '第8期 | mitt、tiny-emitter 发布订阅', link: '/read-source-code/notice/p8' },
					{
					  text: '第7期 | validate-npm-package-name 检测 npm 包是否符合标准',
					  link: '/read-source-code/notice/p7',
					},
					{
					  text: '第6期 | update-notifier 检测 npm 包是否更新',
					  link: '/read-source-code/notice/p6',
					},
					{
					  text: '第5期 | koa-compose 相对较难，觉得难可跳过',
					  link: '/read-source-code/notice/p5',
					},
					{ text: '第4期 | co 源码 觉得较难可先跳过', link: '/read-source-code/notice/p4' },
					{
					  text: '第3期 | vue 3.2 是怎么发布的 vue-release',
					  link: '/read-source-code/notice/p3',
					},
					{ text: '第2期 | vue3 工具函数', link: '/read-source-code/notice/p2' },
					{ text: '第1期 | vue-devtools', link: '/read-source-code/notice/p1' },
				  ],
				},
			  ],
		},
