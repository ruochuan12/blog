...
> 我的博客地址：[https://ruochuan12.github.io](https://ruochuan12.github.io)，**建议加个书签**，也可以必应或者谷歌搜索[**前端若川**](https://www.bing.com/search?q=%E5%89%8D%E7%AB%AF%E8%8B%A5%E5%B7%9D)，找到我。
>
...
- [Taro 源码揭秘 - 4. 每次 npm run dev:weapp 开发小程序，build 编译打包是如何实现的？](https://ruochuan12.github.io/taro/cli-build)
...
- [Taro 源码揭秘：11. Taro 是如何解析入口配置 app.config.ts 和页面配置的？](https://ruochuan12.github.io/taro/mini-plugin-2/)
